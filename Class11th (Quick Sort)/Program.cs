    ...
    internal class Program
    {
        ...
        static void QuickSort(int[] list, int start, int end)
        {
            ...
            while (left <= right)
            {
                ...
                // 7. left가 right보다 작을 때 pivot과 right를 바꾸어줍니다.
                //    left가 right보다 클 경우 left와 right를 바꾸어줍니다.
                if (left > right)
                {
            ...
            // 8. 피벗을 기준으로 나누어진 두 배열에 대해 재귀적으로 퀵 정렬을 호출합니다.
        ...
        static void Main(string[] args)
        {
            ...
            int[] array = { 5, 3, 8, 9, 2, 4, 7, 1, 6, 10 };
